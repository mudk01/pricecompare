...
# change according to machine - get from searching "my user agent" on Google
headers = {"user-agent": """Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:105.0) Gecko/20100101 
            Firefox/105.0"""}   

page = requests.get(target_product_url)
soup = BeautifulSoup(page.content, 'html.parser')

results = soup.find('h1', class_='data-test')   # ERROR: can't find product name...
